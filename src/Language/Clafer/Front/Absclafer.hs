...
data Pos = Pos Integer Integer  deriving (Eq,Ord,Show,Read,Data,Typeable)
noPos :: Pos
noPos = Pos 0 0

data Span = Span Pos Pos deriving (Eq,Ord,Show,Read,Data,Typeable)
noSpan :: Span
...
newtype PosInteger = PosInteger ((Int,Int),String) deriving (Eq,Ord,Show,Read)
newtype PosDouble = PosDouble ((Int,Int),String) deriving (Eq,Ord,Show,Read)
newtype PosString = PosString ((Int,Int),String) deriving (Eq,Ord,Show,Read)
newtype PosIdent = PosIdent ((Int,Int),String) deriving (Eq,Ord,Show,Read)
data Module =
